...
# In order to save genre as a db object with a list of genres as its properties
# we need to define it in its own Model
...
class Show(db.Model):
    ...
    def __repr__(self):
        return "<Show: {},{},{}>".format(self.id, self.artist_id, self.venue_id)
